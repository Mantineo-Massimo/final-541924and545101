...
\begin{frame}{Evidenza: Handshake TCP}
    \centering
    \includegraphics[width=0.85\textwidth, trim=0 80 0 70, clip]{../assets/wireshark_handshake.png}
    \\[0.2cm]
...
\begin{frame}{Evidenza: Autenticazione e JSON}
    \begin{columns}
...
\begin{frame}{6. Ottimizzazioni Architetturali}
...
\begin{frame}{7. Sicurezza e Gestione Vulnerabilità}
...
\begin{frame}{8. Analisi e Load Testing}
...
\begin{frame}{9. Conclusioni e Sviluppi Futuri}
